                        ...
                        case 1:
                            {
                                ...
                                while (a)
                                {
                                    try
                                    {
                                        ...
                                        Console.WriteLine(result);
                                        Console.WriteLine("Finalizaron los recorridos. Presione una tecla para volver al menú principal.");
                                        Console.ReadKey();
                                    }
                                    catch
                                    {
                                        Console.WriteLine("Ocurrió un error. Se regresará al menú principal.");
                                        a = false;
                                    }
                                }
                            }
